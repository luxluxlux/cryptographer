    ...
    return (
        <div className="failure">
            <p className="failure__description">
                <b title={location.state.fileName}>{ellipse(location.state.fileName, 40)}</b> wasn’t{' '}
                {location.state.action}ed. Check if the password or secret key is correct and try
                again.
            </p>
